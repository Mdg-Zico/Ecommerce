...
const entry = InputObject.map((items)=>{
 return <Input
  {...items}
  />
})

const btn = ButtonObject.map((options)=>{
  return <Button
   {...options}
   />
 })
...
export default function SignUp(){
   ...
   const [click, NewClick] = React.useState(false)
 ...
 return   <div className="signup">
       ...
       <div className="signup-form-div" >
            ...
            <form className="signup-form">
                {entry}
                {btn}
                <button onClick={handleClick}  className="signup-button second-form-btn" type="submit">
